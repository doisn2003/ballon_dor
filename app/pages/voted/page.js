          ...
          <div className={styles.votersSection}>
            ...
            <div className={styles.votersTabs}>
              {players.map(player => {
                ...
                // Các địa chỉ ví mẫu từ Hardhat accounts
                const hardhatAddresses = [
                  "0xf39F...2266", "0x7099...79C8", "0x3C44...93BC", 
                  "0x90F7...b906", "0x15d3...6A65", "0x9965...A4dc",
                  "0x976E...0aa9", "0x14dC...9955", "0x2361...1E8f", 
                  "0xa0Ee...9720", "0xBcd4...4096", "0x71bE...5788"
                ];
                
                // Nếu có dữ liệu thực tế, ưu tiên dùng dữ liệu đó
                if (votersData[player.id] && votersData[player.id].addresses.length > 0) {
                  return (
                ...
                // Nếu không có dữ liệu thực tế, tạo dữ liệu mẫu dựa trên số phiếu bầu
